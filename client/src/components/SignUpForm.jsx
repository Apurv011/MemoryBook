    ...
    <div>
      ...
      <form className="login-signup form-container" >
        <div className="form-group">
          ...
          <p className="form-text" style={{color: "#ff0000", fontSize:"12px"}}>{usernameError}</p>
        </div>
        <div className="form-group">
          ...
          <p className="form-text" style={{color: "#ff0000", fontSize:"12px"}}>{emailError}</p>
        </div>
        <div className="form-group">
          <label><b>Password</b></label>
          <input onChange={handleChange} type="password" className="form-control" name="password" value={user.password} />
          <p className="form-text" style={{color: "#ff0000", fontSize:"12px"}}>{passwordError}</p>
        </div>
        <div className="form-group">
